...
\textit{Solution Repository:} \url{https://github.com/zomathon/kpt-prediction}

\textit{Dataset:} \url{https://drive.google.com/kpt-datasets}

\textit{Notebook:} \url{https://colab.research.google.com/kpt-analysis}
\end{center}
...
\textbf{URL:} \url{https://github.com/zomathon/kpt-prediction}
...
\textbf{URL:} \url{https://drive.google.com/kpt-datasets} (Public access)
...
\textbf{URL:} \url{https://colab.research.google.com/kpt-analysis}
...
\subsection*{A.5 Contact \& Questions}

For questions or clarifications about this solution, please reach out:

\textbf{Email:} zomathon-kpt@example.com

\textbf{Team:} [Your Team Name]
